import { MaterialCategory, AvailabilityFrequency, QualityGrade } from '../types/index.js';
...
export const MATCHING_CONFIG = {
  ...
  materialCompatibility: {
    ...
    } as Record<MaterialCategory, MaterialCategory[]>,
  },
  ...
  availabilityFrequency: {
    frequencyScores: {
      ...
      QUARTERLY: 50,
      ONE_TIME: 20,
    } as Record<AvailabilityFrequency, number>,
  },

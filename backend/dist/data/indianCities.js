 ...
 */
function calculateDistanceKm(cityA, cityB) {
    const normA = cityA.trim().toUpperCase();
    const normB = cityB.trim().toUpperCase();
    const cA = exports.INDIAN_CITIES[normA] || Object.values(exports.INDIAN_CITIES).find(c => c.name.toUpperCase().includes(normA));
    const cB = exports.INDIAN_CITIES[normB] || Object.values(exports.INDIAN_CITIES).find(c => c.name.toUpperCase().includes(normB));
    if (!cA || !cB) {
